...
##  [/Kaje.Client](https://github.com/NetCoreTemplates/blazor-tailwind/tree/main/Kaje.Client)
...
## [/Kaje](https://github.com/NetCoreTemplates/blazor-tailwind/tree/main/Kaje)

The .NET 6 `/Kaje` backend server is required for this App's dynamic functions including the Hello API on the home page
